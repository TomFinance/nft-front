      ...
      <section class="dark:bg-jacarta-800 relative py-16 md:py-24">
        <div class="container">
          ...
          <div class="article-content mx-auto max-w-[48.125rem]">
            ...
            <h2 class="text-base">1.1 – CHANGES TO THESE TERMS</h2>
            <p>
            ...
            <h2 class="text-base">‍1.2 – WHAT THESE TERMS CONTAIN</h2>
            <p>
            Our Services<br/>
            Privacy Policy<br/>
            Contacting TOM MARKETPLACE<br/>
            Your Account<br/>
            Acceptable Use and Conduct<br/>
            User Content and NFT Purchase License<br/>
            ...
            <h2 class="text-base">2 – OUR SERVICES</h2>
            <p>
            TOM MARKETPLACE offers a variety of services which may be accessed through the Website (the “Services”). Anyone can browse the Website without registering for an account. However, you need to create an account on the Website to use the Services. All Services are provided "as is," with the possibility of future changes as part of an ongoing effort to improve the Services we offer. 
            </p>

            <h2 class="text-base">2.1 – OTHER SERVICES</h2>
            <p>
            TOM MARKETPLACE may also offer specific services or features such as giveaways, campaigns, contests, sweepstakes, and other events. These other services are subject to additional terms and conditions (the “Additional Terms”), that may contain certain eligibility requirements, such as restrictions as to age and geographic location. You are responsible for reviewing such Additional Terms to determine whether or not you are eligible to participate. The Additional Terms are hereby incorporated by reference into these Terms. In the event that there is an irreconcilable conflict between the Additional Terms and these Terms, the Additional Terms shall prevail.
            </p>


            <h2 class="text-base">2.2 – LIMITS</h2>
            ...
            <h2 class="text-base">2.3 – CHANGES TO OUR SERVICES</h2>
            TOM MARKETPLACE is always expanding and thus you may see changes to our Services without warning. Due to the evolving nature of technologies and the way we do business, we reserve the right, with or without notice, to modify, suspend, terminate, or discontinue providing any of the Services at any time. We release updates on a regular basis, some of which are not publicly announced. These are done to improve system stability, add new features, allow us time to perform routine maintenance, or comply with applicable law. We are not liable in the event that we modify, suspend, terminate or discontinue any part of the Website or its Services.



            <h2 class="text-base">3 – PRIVACY POLICY</h2>
            We ask that you review the terms of our Privacy Policy, so that you are aware of how we collect and use your information.



            <h2 class="text-base">4 – CONTACTING TOM MARKETPLACE<br/>
            4.1 – SUPPORT</h2>
            <p>
            If you are experiencing any issues, are unable to find any information pertaining to your inquiry on our Help Center, or want to reach out to our team, you may do so by sending us an email at ask@tom.finance.
            </p>
            <p>
            ...
            If you are contacting us for business or marketing purposes, you may reach out to us at ask@tom.finance.
            </p>

            <h2 class="text-base">5 – YOUR ACCOUNT</h2>
            <p>
            ...
            <p>
            TOM MARKETPLACE can require you to provide additional information and documents in certain circumstances, such as at the request of any government authority, as any applicable law or regulation dictates, or to investigate a potential violation of these Terms. In such cases, TOM MARKETPLACE, in its sole discretion, can disable your Account and block your ability to access the Services until such additional information and documents are processed by TOM MARKETPLACE. If you do not provide complete and accurate information in response to such a request, TOM MARKETPLACE can refuse to restore your access to the Service. We reserve the right to cancel your account, without notice, for any reason, at any time.
            </p>


            <h2 class="text-base">6 – ACCEPTABLE USE AND CONDUCT</h2>
            <p>
            ...
            <p>
            We may issue a warning and demand that you remedy your violation, where applicable;<br/>
            We may remove the ability to view certain NFTs on the Service or use our Service to interact with the NFTs;<br/>
            We may refuse, disable, or restrict certain portions of your access to our system and/or the ability to use the Service in conjunction with buying/selling/transferring NFTs available on blockchains;<br/>
            We may delete content or data that you have added to our system;<br/>
            We may completely ban you from accessing our system;<br/>
            We may delete your account entirely from our system, with no liability to you; or<br/>
            We may take legal action against users who violate these Terms (including reports to law enforcement authorities).<br/>
            ...
            <h2 class="text-base">7 – USER CONTENT AND NFT PURCHASE LICENSE<br/>
            7.1 – UPLOADING CONTENT</h2>
            <p>
            ...
            <h2 class="text-base">7.3 – NFT PURCHASE LICENSE</h2>
            <p>
            ...
            <p>
            You further acknowledge that NFTs may be subject to terms directly between buyers and sellers with respect to the use of the NFT content and benefits associated with a given NFT (“Purchase Terms”) and that such terms may be accessible via a third-party link to an external website. Such a website may include Purchase Terms governing the use of the NFT with which you must comply. You are solely responsible for reviewing such Purchase Terms. TOM MARKETPLACE is not a party to any such Purchase Terms, which are solely between the buyer and seller, who are entirely responsible for communicating, promulgating, agreeing to, and enforcing such Purchase Terms.
            </p>

            <h2 class="text-base">8 – REPRESENTATIONS AND WARRANTIES</h2>
            <p>
            By using our Services, you represent and warrant that:
            </p>
            <p>
            You will submit true, accurate, current, and complete registration information;<br/>
            You will maintain the accuracy of such information and promptly update such registration information as necessary;<br/>
            You have the legal capacity and you agree to comply with these Terms;<br/>
            You are not a minor in the jurisdiction in which you reside, or if a minor, you have received parental permission to use our Services;<br/>
            You have the right to grant TOM MARKETPLACE the appropriate license to your content;<br/>
            You will not use our Services for any illegal or unauthorized purpose; and<br/>
            Your use of our Services will not violate any applicable law or regulation.
            ‍</p>

            <h2 class="text-base">9 – INTELLECTUAL PROPERTY RIGHTS<br/>
            9.1 – TRADEMARKS</h2>
            <p>
            ...
            <h2 class="text-base">9.2 – OTHER INTELLECTUAL PROPERTY</h2>
            <p>
            Our Services and their entire contents, features, and functionality (including but not limited to all information, software, text, displays, images, video, and audio, and the design, selection, and arrangement thereof) are owned by TOM MARKETPLACE, its affiliates, its licensors, or other providers of such material and are protected by Seychelles and international copyright, trademark, patent, trade secret, and other intellectual property or proprietary rights laws. The material may not be copied, modified, reproduced, downloaded or distributed in any way, in whole or in part, without the express prior written permission of us, unless and except as is expressly provided in these Terms.
            </p>

            <h2 class="text-base">9.3 – LINKING TO OUR SITE</h2>
            <p>
            You may link to our homepage (https://TOMNFT.io/) provided you do so in a way that is fair and legal and does not damage our reputation or take advantage of it.
            </p>
            <p>
            ...
            <p>
            If you wish to link to or make any use of content on our site other than that set out above, please contact ask@tom.finance.
            </p>

            <h2 class="text-base">10 – INTELLECTUAL PROPERTY POLICY</h2>
            <p>
            We want to ensure that the content that we host does not infringe the proprietary rights of others.
            </p>
            <p>
            If you are the owner of content that is being improperly used on our Website without your permission, you may request that the content be removed. To make such a request, please email us with the required information at ask@tom.finance.
            </p>
            <p>
            ...
            a statement that the complainant submits to the jurisdiction of the courts in Seychelles for the purposes of any proceedings relating to the allegedly infringing material;
            the physical or electronic signature of the owner of or of a person authorized to act on behalf of the owner of the IP or of an exclusive right that is allegedly infringed;<br/>
            Please also attach the following:<br/>
            &nbsp;&nbsp;&nbsp;○ Proof of your identity;<br/>
            &nbsp;&nbsp;&nbsp;○ Proof of ownership of the IP from the proper authority, if any;<br/>
            &nbsp;&nbsp;&nbsp;○ Proof of right to use the IP granted by owner; and<br/>
            &nbsp;&nbsp;&nbsp;○ Proof of authority to represent the IP owner, if not the IP owner.<br/>
            Certified English translations of any of the above, as applicable.<br/>
            ...
            a statement that you submit to the jurisdiction of the courts in Seychelles for the purposes of any proceedings relating to the material; and
            ...
            <h2 class="text-base">11– THIRD PARTY WEBSITES AND CONTENT</h2>
            <p>
            ...
            <h2 class="text-base">12 – DISCLAIMER OF WARRANTIES</h2>
            <p>
            ...
            <p>
            Moreover, transactions on the Website and through the Services, including but not limited to primary sales, secondary market sales, listings, offers, bids, acceptances, and other operations, utilize experimental smart contract and blockchain technology, including non-fungible tokens, cryptocurrencies, consensus algorithms, and peer-to-peer or decentralized networks and systems. You acknowledge and agree that such technologies are experimental, speculative, and inherently risky and may be subject to bugs, malfunctions, timing errors, hacking and theft, or changes to the protocol rules of the relevant blockchain, which can adversely affect the smart contracts and may expose you to a risk of total loss, forfeiture of your digital currency or NFT, or lost opportunities to buy or sell NFTs. TOM MARKETPLACE is not responsible for sustained losses due to vulnerability or any kind of failure, abnormal behavior of software (e.g., wallet, smart contract) or the associated blockchain, or for sustained losses due to late reports by developers or representatives (or no report at all) of any issues with the blockchain supporting the NFTs including forks, technical node issues or any other issues having fund losses as a result. 
            </p>
            <p>
            THE SERVICES, AND ALL MATERIALS, INFORMATION, PRODUCTS AND SERVICES INCLUDED IN THE SERVICES ARE CURRENTLY BEING PROVIDED AS A “BETA” VERSION AND MADE AVAILABLE ON AN “AS IS,” OR “AS AVAILABLE” BASIS WITH NO WARRANTIES WHATSOEVER. TOM MARKETPLACE, ITS SUPPLIERS AND ITS LICENSORS EXPRESSLY DISCLAIM TO THE FULLEST EXTENT PERMITTED BY LAW ALL EXPRESS, IMPLIED, AND STATUTORY WARRANTIES, INCLUDING, WITHOUT LIMITATION, THE WARRANTIES OF TITLE, FUNCTIONALITY, MERCHANTABILITY, USAGE, SECURITY, SUITABILITY OR FITNESS FOR A PARTICULAR PURPOSE, NON-INFRINGEMENT OF PROPRIETARY RIGHTS, WORKMANSHIP OR TECHNICAL QUALITY OF ANY NFT OR WORK, SMART CONTRACT CODE, OR SOFTWARE. TOM MARKETPLACE, ITS SUPPLIERS AND ITS LICENSORS DISCLAIM ANY WARRANTIES REGARDING THE SECURITY, RELIABILITY, TIMELINESS, AND PERFORMANCE OF THE SERVICES. TOM MARKETPLACE, ITS SUPPLIERS AND ITS LICENSORS DISCLAIM, ANY WARRANTIES FOR ANY INFORMATION OR ADVICE OBTAINED THROUGH THE SERVICES. TOM MARKETPLACE, ITS SUPPLIERS AND ITS LICENSORS DISCLAIM ANY WARRANTIES FOR SERVICES OR GOODS RECEIVED THROUGH OR ADVERTISED ON THE SERVICES OR RECEIVED THROUGH ANY LINKS PROVIDED BY THE SERVICES, AS WELL AS FOR ANY INFORMATION OR ADVICE RECEIVED THROUGH ANY LINKS PROVIDED IN THE SERVICES.
            </p>
            <p>
            YOU UNDERSTAND AND AGREE THAT: (A) THE SERVICES WILL NOT BE UNINTERRUPTED OR ERROR-FREE; (B) THERE IS NO WARRANTY OR GUARANTEE THAT THE SERVICES WILL OPERATE AT ANY MINIMUM DATA TRANSFER SPEED; (C) TOM MARKETPLACE HAS NO CONTROL OVER THIRD PARTY NETWORKS OR SITES YOU MAY ACCESS IN THE COURSE OF YOUR USE OF THE SERVICES; (D) YOU DOWNLOAD OR OTHERWISE OBTAIN MATERIAL OR DATA THROUGH THE USE OF THE SERVICES AT YOUR OWN DISCRETION AND RISK AND THAT YOU WILL BE SOLELY RESPONSIBLE FOR ANY DAMAGES TO YOUR COMPUTER SYSTEM OR LOSS OF DATA THAT RESULTS FROM THE DOWNLOAD OF SUCH MATERIAL OR DATA; AND (E) TOM MARKETPLACE WILL NOT BE LIABLE FOR ANY LOSS OR DAMAGE CAUSED BY A DISTRIBUTED DENIAL-OF-SERVICE ATTACK, VIRUSES, OR OTHER TECHNOLOGICALLY HARMFUL MATERIAL THAT MAY INFECT YOUR COMPUTER EQUIPMENT, COMPUTER PROGRAMS, DATA, OR OTHER PROPRIETARY MATERIAL DUE TO YOUR USE OF THE SERVICES OR TO YOUR DOWNLOADING OF ANY MATERIAL POSTED THROUGH THE SERVICES, OR ON ANY WEBSITE LINKED TO IT.
            </p>
            <p>
            ...
            <p>
            CRYPTOCURRENCY ASSETS (INCLUDING, WITHOUT LIMITATION, NFTS) ARE INTANGIBLE DIGITAL ASSETS WHICH EXIST ONLY BY VIRTUE OF THE OWNERSHIP RECORD MAINTAINED ON THE ASSOCIATED BLOCKCHAIN. THE ASSOCIATED BLOCKCHAIN IS NOT UNDER THE CONTROL OR INFLUENCE OF TOM MARKETPLACE. TOM MARKETPLACE CANNOT EFFECT OR OTHERWISE CONTROL THE TRANSFER OR RIGHT IN ANY NFTS OR UNDERLYING OR ASSOCIATED CONTENT.
            </p>
            <p>
            SOME STATES OR OTHER JURISDICTIONS DO NOT ALLOW THE EXCLUSION OF IMPLIED WARRANTIES, SO THE ABOVE EXCLUSIONS MAY NOT APPLY TO YOU. YOU MAY ALSO HAVE OTHER RIGHTS THAT VARY FROM STATE TO STATE AND JURISDICTION TO JURISDICTION. NO ADVICE OR INFORMATION, WHETHER ORAL OR WRITTEN, OBTAINED BY YOU FROM TOM MARKETPLACE OR ITS SUCCESSORS, AFFILIATES, CONTRACTORS, EMPLOYEES, SUPPLIERS, LICENSORS, PARTNERS OR AGENTS, OR THROUGH OR FROM THE SERVICES (INCLUDING THROUGH SUPPORT SERVICES OR PROFESSIONAL SERVICES) SHALL CREATE ANY WARRANTY NOT EXPRESSLY STATED IN THE TERMS.
            </p>

            <h2 class="text-base">13 – INDEMNITY</h2>
            <p>
            To the fullest extent permitted by applicable law, you agree to indemnify, defend and hold harmless TOM MARKETPLACE and our past, present and future employees, officers, directors, contractors, consultants, equity holders, suppliers, vendors, service providers, parent companies, subsidiaries, affiliates, agents, representatives, predecessors, successors and assigns (individually and collectively the “TOM MARKETPLACE Parties”), from and against all actual or alleged third party claims, damages, awards, judgments, losses, liabilities, obligations, penalties, interest, fees, expenses (including, without limitation, court costs, costs of settlement and costs of pursuing indemnification and insurance), of every kind and nature whatsoever, whether known or unknown, foreseen or unforeseen, matured or unmatured, or suspected or unsuspected, in law or equity, whether in tort, contract or otherwise (collectively, “Claims”), including, but not limited to, damages to property or personal injury, that are caused by, arise out of or are related to (a) your use or misuse of the Website, User Content or NFTs; (b) your breach of these Terms; (c) your breach of any applicable law and regulation; (d) your breach or violation of the rights of a third party, including another user or third party service provider. You agree to promptly notify TOM MARKETPLACE of any third-party Claims and cooperate with the TOM MARKETPLACE Parties in defending such Claims. You further agree that the TOM MARKETPLACE Parties shall have control of the defense or settlement of any such third-party Claims.
            </p>

            <h2 class="text-base">14 – LIMITATION OF LIABILITY</h2>
            <p>
            YOU AGREE THAT, UNDER NO LEGAL THEORY, INCLUDING, BUT NOT LIMITED TO NEGLIGENCE, SHALL TOM MARKETPLACE OR THE TOM MARKETPLACE PARTIES, BE LIABLE TO YOU FOR ANY COMPENSATORY, DIRECT, INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR EXEMPLARY DAMAGES, INCLUDING, BUT NOT LIMITED TO, DAMAGES FOR LOSS OF PROFITS, COST OF COVER, GOODWILL, USE, DATA, OR OTHER INTANGIBLE LOSSES (REGARDLESS IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES), ARISING FROM OR RELATING TO THESE TERMS OR YOUR USE OR THE INABILITY TO USE THE SERVICES.
            </p>
            <p>
            THESE LIMITATIONS SHALL ALSO APPLY WITH RESPECT TO DAMAGES INCURRED BY REASON OF ANY PRODUCTS OR SERVICES SOLD OR PROVIDED ON ANY THIRD PARTY SITES OR OTHERWISE PROVIDED BY ANY THIRD PARTIES OTHER THAN TOM MARKETPLACE (INCLUDING THIRD PARTY APPLICATION DEVELOPERS) AND RECEIVED BY YOU THROUGH OR ADVERTISED ON THE SERVICES OR RECEIVED BY YOU ON ANY THIRD PARTY SITES.
            </p>
            <p>
            CERTAIN JURISDICTIONS DO NOT ALLOW LIMITATIONS ON IMPLIED WARRANTIES OR THE EXCLUSION OR LIMITATION OF CERTAIN DAMAGES. IF YOU RESIDE IN SUCH A JURISDICTION, SOME OR ALL OF THE ABOVE DISCLAIMERS, EXCLUSIONS, OR LIMITATIONS MAY NOT APPLY TO YOU, AND YOU MAY HAVE ADDITIONAL RIGHTS. THE LIMITATIONS OR EXCLUSIONS OF WARRANTIES, REMEDIES OR LIABILITY CONTAINED IN THESE TERMS APPLY TO YOU TO THE FULLEST EXTENT SUCH LIMITATIONS OR EXCLUSIONS ARE PERMITTED UNDER THE LAWS OF THE JURISDICTION IN WHICH YOU ARE LOCATED.
            </p>

            <h2 class="text-base">15 – ASSUMPTION OF RISK</h2>
            <p>
            ...
            <p>
            Price, liquidity, and scarcity of blockchain assets, including NFTs, are extremely volatile and may be subject to fluctuations;<br/>
            Fluctuations in the price of other digital assets could materially and adversely affect NFTs;<br/>
            Legislative and regulatory changes or actions may adversely affect the use, transfer, and value of NFTs. The regulatory regime governing blockchain technologies, NFTs, cryptocurrency, and other crypto-based items is uncertain, and new regulations or policies may materially adversely affect the development of the Website and the utility of NFTs;<br/>
            ...
            A lack of use or public interest in the creation and development of distributed ecosystems could negatively impact the development of those ecosystems and related applications, and could therefore also negatively impact the potential utility of NFTs;<br/>
            ...
            NFTs are subject to the risk of fraud, counterfeiting, cyber-attacks, risks that third parties may obtain unauthorized access to your third-party wallet or Account, and other technological difficulties which may prevent access to or use of your NFTs;<br/>
            Withdrawal of an NFT to a decentralized digital asset wallet is at your own risk, and the transfer for any NFT to an incorrect digital asset wallet address will result in the irreversible loss of such NFT;<br/>
            Experimental cryptographic technologies and blockchain technologies are used by the Website, and such technologies are novel, experimental, and speculative, and there is significant uncertainty regarding the operation and effects and risks thereof;<br/>
            The Website uses public peer-to-peer networks, public blockchains, and certain smart contracts and protocols that are not under the control or influence of TOM MARKETPLACE or any of its affiliates and are subject to many risks and uncertainties;<br/>
            Costs and speeds of transacting with cryptographic and blockchain-based systems are variable and may increase or decrease dramatically at any time, resulting in prolonged inability to access or use any NFTs associated with the Website;<br/>
            ...
            <p>
            YOU RELEASE US AND THE TOM MARKETPLACE PARTIES FROM CLAIMS, DEMANDS, AND DAMAGES OF EVERY KIND AND NATURE, KNOWN AND UNKNOWN, ARISING OUT OF OR IN ANY WAY CONNECTED WITH SUCH DISPUTES. IN ENTERING INTO THIS RELEASE YOU EXPRESSLY WAIVE ANY PROTECTIONS (WHETHER STATUTORY OR OTHERWISE) THAT WOULD OTHERWISE LIMIT THE COVERAGE OF THIS RELEASE TO INCLUDE THOSE CLAIMS WHICH YOU MAY KNOW OR SUSPECT TO EXIST IN YOUR FAVOR AT THE TIME OF AGREEING TO THIS RELEASE.
            </p>

            <h2 class="text-base">16 – TERMINATION</h2>
            <p>
            ...
            <h2 class="text-base">17 – GOVERNING LAW</h2>
            <p>
            You agree that all matters relating to the Services and these Terms, and any dispute or claim arising therefrom or related, shall be governed by and construed in accordance with the laws of Seychelles (without reference to conflict of laws principles).
            </p>

            <h2 class="text-base">18 – DISPUTE RESOLUTION<br/>
            18.1 – Jurisdiction</h2>
            <p>
            You agree to file any legal suit, action, or proceeding (each a “Dispute”) arising out of, or related to, these Terms or the Services exclusively in the courts of Seychelles, although we retain the right to bring any Dispute against you for breach of these Terms in your country of residence or any other relevant country. You agree to submit to the personal jurisdiction of, and agree that venue is proper in, the courts located in Seychelles any Dispute relating to us or these Terms.
            </p>
            <p>
            ...
            <h2 class="text-base">18.2 – Waiver by Jury Trial</h2>
            <p>
            ...
            <h2 class="text-base">18.3 – Arbitration</h2>
            <p>
            At TOM MARKETPLACE’s sole discretion and election, we may require you to refer any Disputes arising from these Terms or use of the Services, including disputes arising from or concerning their interpretation, violation, invalidity, non-performance, or termination, to be finally resolved by arbitration administered by the Seychelles Court. And the language of the arbitration shall be English.
            </p>

            <h2 class="text-base">18.4 – Limitation on time to file claims</h2>
            <p>
            ...
            <h2 class="text-base">19 – OTHER PROVISIONS<br/>19.1 – Reasonableness</h2>
            <p>
            ...
            <h2 class="text-base">19.2 – No Waiver</h2>
            <p>
            No waiver by TOM MARKETPLACE or any term or condition set out in these Terms shall be deemed a further or continuing waiver of such term or condition or a waiver of any other term or condition, and any failure of TOM MARKETPLACE to assert a right or provision under these Terms shall not constitute a waiver of such right or provision.
            </p>

            <h2 class="text-base">19.3 – Severability</h2>
            <p>
            ...
            <h2 class="text-base">19.4 – Relationship of the Parties</h2>
            <p>
            You, third parties, and we are all independent parties with respect to each other. These Terms not mean an agency or partnership between us and you or any third party. It also does not constitute a joint venture, or an employment relationship. You agree that TOM MARKETPLACE has no special relationship with or beneficiary duty to you. No parties to these Terms (including us, you, and any third party) have the right to enter into an agreement for or on the behalf of any other agreeing party. No parties to these Terms may become involved in a situation that results in obligation or liability of any other agreeing party. 
            </p>

            <h2 class="text-base">19.5 – Entire Agreement</h2>
            <p>
            These Terms, our Privacy Policy, and our Cookies Policy constitute the sole and entire agreement between you and TOM MARKETPLACE regarding the Services and supersede all prior and contemporaneous understandings, agreements, representations, and warranties, both written and oral, regarding the Services.
            </p>
