...
const NFTItemUpload = () => {
  ...
  const changeHandler = (event) => {
    ...
    reader.onload = function (e) {
      ...
      image.onload = function () {
        ...
        $("#blah").attr("src", e.target.result).attr("object-fit", "fit");
        // .width(150)
        // .height(200);
  ...
  const {
    isLoading: isLoadingNftImage,
    isError: isErrorNftImage,
    status: statusNftImage,
    mutate: mutateNftImage,
  } = useMutation((data) => {
  ...
  const handleSubmit = (e) => {
    ...
    mutateNftImage(formData, {
      onSuccess: ({ data }) => {
        ...
        const currency = "ETH"; //mintCurrency;;
          ...
          onSuccess: async (data) => {
            ...
            if (ethereum) {
              ...
              const response = await axios.post(
                "https://api.skyhall.io/api/v1/upload/nftMinted",
                {
                  uploadNftId,
                  hash: tx.hash,
                },
              ...
              <div className="mb-6">
                ...
                >
                  <div className="relative z-10 cursor-pointer">
                    ...
                    <p
                      className="mx-auto max-w-xs text-xs dark:text-jacarta-300"
                      id="file_info"
                    >
                  ...
                  <p className="text-2xs dark:text-jacarta-300">
                    ...
                    for work (NSFW) content, will protect users with safe search while browsing Xhibiter."
                      >
                        ...
                        0 16zM11 7h2v2h-2V7zm0 4h2v6h-2v-6z"
                          ></path>
                        </svg>
                      </Tippy>
                    </span>
