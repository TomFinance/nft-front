            ...
            <div className='mb-6 inline-flex rounded-full bg-[#CDBCFF] p-3'>
              <div className='inline-flex h-12 w-12 items-center justify-center rounded-full bg-accent'>
                <svg
                  ...
                  <path
                    d='M22 6h-7a6 6 0 1 0 0 12h7v2a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h18a1 1 0 0 1 1 1v2zm-7
									2h8v8h-8a4 4 0 1 1 0-8zm0 3v2h3v-2h-3z'
                  />
                </svg>
              </div>
            </div>
            ...
            <div className='mb-6 inline-flex rounded-full bg-[#CDDFFB] p-3'>
              <div className='inline-flex h-12 w-12 items-center justify-center rounded-full bg-blue'>
                <svg
                  ...
                  <path fill='none' d='M0 0h24v24H0z' />
                  <path
                    d='M17.409 19c-.776-2.399-2.277-3.885-4.266-5.602A10.954 10.954 0 0 1 20 11V3h1.008c.548
									0 .992.445.992.993v16.014a1 1 0 0 1-.992.993H2.992A.993.993 0 0 1 2 20.007V3.993A1 1 0 0 1 2.992
									3H6V1h2v4H4v7c5.22 0 9.662 2.462 11.313 7h2.096zM18 1v4h-8V3h6V1h2zm-1.5 9a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3z'
                  />
                </svg>
              </div>
            </div>
            ...
            <div className='mb-6 inline-flex rounded-full bg-[#FFD0D0] p-3'>
              <div className='inline-flex h-12 w-12 items-center justify-center rounded-full bg-red'>
                <svg
                  ...
                  <path fill='none' d='M0 0h24v24H0z' />
                  <path
                    d='M10.9 2.1l9.899 1.415 1.414 9.9-9.192 9.192a1 1 0 0 1-1.414 0l-9.9-9.9a1 1 0 0 1 0-1.414L10.9
									2.1zm2.828 8.486a2 2 0 1 0 2.828-2.829 2 2 0 0 0-2.828 2.829z'
                  />
                </svg>
              </div>
            </div>
