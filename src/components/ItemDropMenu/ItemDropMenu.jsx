...
const ItemDropMenu = () => {
  return (
    <div
      className='dropdown-menu dropdown-menu-end show z-10 hidden min-w-[200px] whitespace-nowrap 
			rounded-xl bg-white py-4 px-2 text-left shadow-xl dark:bg-jacarta-800'
