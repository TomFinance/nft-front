...
const MobileMenu = ({ setMobileMenuIsOpen }) => {
  const isMobile = useMediaQuery({
    query: '(min-width: 1024px)',
  });

  useEffect(() => {
    isMobile && setMobileMenuIsOpen(false);
  }, [isMobile, setMobileMenuIsOpen]);

  return (
    <div
      className='js-mobile-menu nav-menu--is-open invisible fixed inset-0 z-[100] ml-auto items-center 
		bg-white opacity-0 dark:bg-jacarta-800 lg:visible lg:relative lg:inset-auto lg:flex lg:bg-transparent 
		lg:opacity-100 dark:lg:bg-transparent'>
      {/* mobile logo */}
      <div
        className='t-0 fixed left-0 z-10 flex w-full items-center justify-between bg-white 
			p-6 dark:bg-jacarta-800 lg:hidden'>
        <Logo />
        <button
          onClick={() => setMobileMenuIsOpen(false)}
          className='js-mobile-close group ml-2 flex h-10 w-10 items-center justify-center rounded-full border 
      ...
      <form action='search' className='relative mt-24 mb-8 w-full lg:hidden'>
        <input
          type='text'
          className='w-full rounded-2xl border border-jacarta-100 py-3 px-4 pl-10 text-jacarta-700 
					placeholder-jacarta-500 focus:ring-accent dark:border-transparent dark:bg-white/[.15] 
        ...
        <span className='absolute left-0 top-0 flex h-full w-12 items-center justify-center rounded-2xl'>
          <svg
            ...
            <path fill='none' d='M0 0h24v24H0z' />
            <path
              d='M18.031 16.617l4.283 4.282-1.415 1.415-4.282-4.283A8.96 8.96 0 0 1 11 20c-4.968 
      ...
      <div className='mt-10 w-full lg:hidden'>
        <Link
          to='#'
          className='js-wallet block w-full rounded-full bg-accent 
				py-3 px-8 text-center font-semibold text-white shadow-accent-volume transition-all hover:bg-accent-dark'>
          Connect Wallet
        </Link>
        ...
        <div className='flex items-center justify-center space-x-5'>
            ...
            <svg
              ...
              <path
                d='M504 256C504 119 393 8 256 8S8 119 8 256c0 123.78 90.69 226.38 209.25 
						...
						482.38 504 379.78 504 256z'></path>
            </svg>
          </Link>
          <Link to='#' className='group'>
            <svg
            ...
            <svg
              ...
              <path
                d='M524.531,69.836a1.5,1.5,0,0,0-.764-.7A485.065,485.065,0,0,0,404.081,32.03a1.816,1.816,
						...
						0,0,0-15.135-30.6,1.89,1.89,0,0,0-1.924-.91A483.689,483.689,0,0,0,116.085,69.137a1.712,1.712,0,0,
						0-.788.676C39.068,183.651,18.186,294.69,28.43,404.354a2.016,2.016,0,0,0,.765,1.375A487.666,487.666,
						0,0,0,176.02,479.918a1.9,1.9,0,0,0,2.063-.676A348.2,348.2,0,0,0,208.12,430.4a1.86,1.86,0,0,
						0-1.019-2.588,321.173,321.173,0,0,1-45.868-21.853,1.885,1.885,0,0,1-.185-3.126c3.082-2.309,6.166-4.711,
						9.109-7.137a1.819,1.819,0,0,1,1.9-.256c96.229,43.917,200.41,43.917,295.5,0a1.812,1.812,0,0,1,
						1.924.233c2.944,2.426,6.027,4.851,9.132,7.16a1.884,1.884,0,0,1-.162,3.126,301.407,301.407,0,0,
						1-45.89,21.83,1.875,1.875,0,0,0-1,2.611,391.055,391.055,0,0,0,30.014,48.815,1.864,1.864,0,0,0,
						2.063.7A486.048,486.048,0,0,0,610.7,405.729a1.882,1.882,0,0,0,.765-1.352C623.729,277.594,590.933,
						167.465,524.531,69.836ZM222.491,337.58c-28.972,0-52.844-26.587-52.844-59.239S193.056,219.1,222.491,
						219.1c29.665,0,53.306,26.82,52.843,59.239C275.334,310.993,251.924,337.58,222.491,337.58Zm195.38,
						0c-28.971,0-52.843-26.587-52.843-59.239S388.437,219.1,417.871,219.1c29.667,0,53.307,26.82,52.844,
						59.239C470.715,310.993,447.538,337.58,417.871,337.58Z'></path>
            </svg>
          </Link>
          <Link to='#' className='group'>
            <svg
          ...
          <Link to='#' className='group'>
            <svg
              ...
              viewBox='0 0 448 512'>
              <path
                d='M448,209.91a210.06,210.06,0,0,1-122.77-39.25V349.38A162.55,162.55,0,1,1,185,188.31V278.2a74.62,
						74.62,0,1,0,52.23,71.18V0l88,0a121.18,121.18,0,0,0,1.86,22.17h0A122.18,122.18,0,0,0,381,102.39a121.43,
						121.43,0,0,0,67,20.14Z'></path>
            </svg>
          </Link>
        </div>
      </div>
