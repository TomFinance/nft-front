      ...
      <li className='nav-item' role='presentation' onClick={() => setActiveTab('properties')}>
        <button
          ...
          <svg
            ...
            className='mr-1 h-5 w-5 fill-current'>
            <path fill='none' d='M0 0h24v24H0z' />
            <path d='M6.17 18a3.001 3.001 0 0 1 5.66 0H22v2H11.83a3.001 3.001 0 0 1-5.66 0H2v-2h4.17zm6-7a3.001 3.001 0 0 1 5.66 
						0H22v2h-4.17a3.001 3.001 0 0 1-5.66 0H2v-2h10.17zm-6-7a3.001 3.001 0 0 1 5.66 0H22v2H11.83a3.001 3.001 0 0 1-5.66 0H2V4h4.17z' />
          </svg>
