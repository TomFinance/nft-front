        ...
        <div className='flex flex-wrap'>
          <button
            ...
            <svg
              ...
              <path
                d='M10.9 2.1l9.899 1.415 1.414 9.9-9.192 9.192a1 1 0 0 1-1.414 0l-9.9-9.9a1 1 0 0 1 0-1.414L10.9 2.1zm.707 
							2.122L3.828 12l8.486 8.485 7.778-7.778-1.06-7.425-7.425-1.06zm2.12 6.364a2 2 0 1 1 2.83-2.829 2 2 0 0 1-2.83 2.829z'></path>
            </svg>
            <span className='text-2xs font-medium'>Listing</span>
          </button>
          <button
            className='mr-2.5 mb-2.5 inline-flex items-center rounded-xl border border-transparent bg-accent px-4 py-3 
					hover:bg-accent-dark dark:hover:bg-accent-dark'>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              viewBox='0 0 24 24'
              width='24'
          ...
          <button
            className='group mr-2.5 mb-2.5 inline-flex items-center rounded-xl border border-jacarta-100 bg-white px-4 
					py-3 hover:border-transparent hover:bg-accent hover:text-white dark:border-jacarta-600 dark:bg-jacarta-700 dark:text-white 
            ...
            <svg
              ...
              <path
                d='M16.05 12.05L21 17l-4.95 4.95-1.414-1.414 2.536-2.537L4 18v-2h13.172l-2.536-2.536 1.414-1.414zm-8.1-10l1.414 1.414L6.828 
							6 20 6v2H6.828l2.536 2.536L7.95 11.95 3 7l4.95-4.95z'></path>
            </svg>
            ...
            <svg
              ...
              <path
                d='M6.5 2h11a1 1 0 0 1 .8.4L21 6v15a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V6l2.7-3.6a1 1 0 0 1 .8-.4zM19 8H5v12h14V8zm-.5-2L17 
							4H7L5.5 6h13zM9 10v2a3 3 0 0 0 6 0v-2h2v2a5 5 0 0 1-10 0v-2h2z'></path>
            </svg>
      ...
      <div
        ...
        <div className='flex' role='row'>
          ...
          <div
            ...
            role='cell'>
            <Link to='/user' className='text-accent'>
              AD496A
            </Link>
          </div>
          <div
        ...
        <div className='flex' role='row'>
          <div
            ...
            <svg
              ...
              <path fill='none' d='M0 0h24v24H0z'></path>
              <path
                d='M16.05 12.05L21 17l-4.95 4.95-1.414-1.414 2.536-2.537L4 18v-2h13.172l-2.536-2.536 1.414-1.414zm-8.1-10l1.414 
							1.414L6.828 6 20 6v2H6.828l2.536 2.536L7.95 11.95 3 7l4.95-4.95z'></path>
            </svg>
            Transfer
          </div>
          <div
